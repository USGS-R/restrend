...
If you are interested in becoming the official sponser and maintainer of `restrend`, please email gs-w_r_admin@usgs.gov.
...
To install the `restrend` package, first install the "remotes" package. Then, using the remotes package, install "smwrData", "smwrBase", "smwrGraphs", "smwrStats", and "smwrQW":
...
remotes::install_github("USGS-R/restrend")
```
